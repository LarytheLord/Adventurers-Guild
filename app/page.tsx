...
export default function AdventurersGuildLanding() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      {/* Hero Section */}
      <section ref={heroRef} className="relative min-h-screen flex items-center justify-center pt-16 sm:pt-20">
        ...
        <motion.div style={{ scale: scaleAndFade, opacity: opacityFade }} className="relative z-20">
            <motion.div 
            ...
            >
              ...
              <motion.h1 variants={fadeInUp} transition={{ duration: 0.7, ease: "easeOut" }} className="text-4xl sm:text-6xl md:text-8xl lg:text-9xl font-black mb-6 sm:mb-8 text-foreground leading-none tracking-tight">
                ADVENTURERS
                <br />
                GUILD
              </motion.h1>
              
              <motion.p variants={fadeInUp} transition={{ duration: 0.7, ease: "easeOut" }} className="text-lg sm:text-2xl md:text-3xl lg:text-4xl font-bold mb-8 sm:mb-12 text-foreground/90 max-w-4xl mx-auto leading-tight px-4">
      ...
      >
        <div className="container mx-auto max-w-6xl">
          <motion.div variants={fadeInUp} transition={{ duration: 0.7, ease: "easeOut" }} className="text-center mb-12 sm:mb-16 md:mb-20">
          ...
          <div className="grid sm:grid-cols-2 gap-8 sm:gap-12 md:gap-16">
            {[
              { title: "Theory Without Practice", desc: "Students graduate with knowledge but no real-world experience. Employers want skills, not just grades.", number: "01" },
              { title: "Passive Learning", desc: "Lectures and textbooks don't prepare you for the dynamic, collaborative nature of modern tech work.", number: "02" },
              { title: "No Industry Connection", desc: "Universities operate in isolation from the companies that will eventually hire their graduates.", number: "03" },
              { title: "Unclear Progression", desc: "Students have no clear path to measure their growth or understand what skills they need next.", number: "04" }
            ].map((item) => (
              <motion.div variants={fadeInUp} transition={{ duration: 0.7, ease: "easeOut" }} key={item.number} className="flex items-start space-x-4 sm:space-x-6 hover:translate-y-[-4px] transition-transform duration-300 ease-out">
      ...
      >
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 md:gap-16 items-center">
            <motion.div variants={fadeInLeft} transition={{ duration: 0.7, ease: "easeOut" }}>
              <Image 
            ...
            <motion.div variants={fadeInRight} transition={{ duration: 0.7, ease: "easeOut" }} className="space-y-8 sm:space-y-12">
              {[
                { title: "Real Quests", desc: "Work on actual projects commissioned by real companies. Build solutions that matter."},
                { title: "XP & Rankings", desc: "Earn experience points and climb from F-Rank to S-Rank. Clear progression, real rewards."},
                { title: "Guild Community", desc: "Join a community of ambitious developers. Collaborate, compete, and grow together."},
                { title: "Industry Mentorship", desc: "Get guidance from experienced professionals who've walked the path before you."}
              ].map((item, index) => (
      ...
      >
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {[...Array(3)].map((_, index) => (
              <motion.div variants={scaleIn} transition={{ duration: 0.6, ease: "easeOut" }} key={index}>
                <Card className="bg-background rounded-2xl shadow-lg p-6 sm:p-8 flex flex-col justify-between h-full
          ...
          <div className="relative overflow-hidden">
            ...
            <div className="flex animate-scroll whitespace-nowrap">
              <div className="flex space-x-20 pr-20">
                <div className="flex items-center justify-center w-[200px]"><Image src="https://ik.imagekit.io/ulajgq5pme/output-onlinepngtools.png?updatedAt=1754142825193" alt="GSSOC" width={180} height={60} className="h-12 w-auto object-contain opacity-70 hover:opacity-100 transition-opacity"/></div>
                <div className="flex items-center justify-center w-[200px]"><span className="text-3xl font-bold text-muted-foreground hover:text-foreground transition-colors duration-300">AI GRANT</span></div>
                <div className="flex items-center justify-center w-[200px]"><Image src="https://ik.imagekit.io/ulajgq5pme/output-onlinepngtools.png?updatedAt=1754142825193" alt="GSSOC" width={180} height={60} className="h-12 w-auto object-contain opacity-70 hover:opacity-100 transition-opacity"/></div>
                <div className="flex items-center justify-center w-[200px]"><span className="text-3xl font-bold text-muted-foreground hover:text-foreground transition-colors duration-300">AI GRANT</span></div>
              </div>
              <div className="flex space-x-20 pr-20">
